...
#define DEFINED_VER_RC_FILEVERSION 4,1,3,10
#define DEFINED_VER_RC_FILEVERSION_STRING "4, 1, 3, 10\0"
#define DEFINED_VER_FULLVERSION_STRING  "4.1.3-beta.1"
